...
describe Reference, :type => :model do
  before :each do
    ...
    @reference = Reference.create(name: "红楼梦", describe: "文学巨著", kind: "文章", tags_name: [@tag.name])
  end
